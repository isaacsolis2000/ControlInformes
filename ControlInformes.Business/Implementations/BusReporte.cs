...
public class BusReporte : IBusReporte
{
    ...
    private readonly ILogger<BusReporte> _logger;

    public BusReporte(IDatPublicador datPublicador, IDatInformeMensual datInforme, IDatAsistencia datAsistencia, ILogger<BusReporte> logger)
    {
